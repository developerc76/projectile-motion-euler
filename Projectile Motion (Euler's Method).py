...
def printMethod(h, g, m, k, vi, angle, dt, endtime, time, dist):
    ...
    print(f"Height: {minheight}; Time: {timelist[indexforminheight]}; Range: {ddata[indexforminheight]}")
...
def euler():
    ...
    graph = input("Would you like a graph? If not, then you will receive standard output (Y/n): ")
    time = 0
    dist = 0
